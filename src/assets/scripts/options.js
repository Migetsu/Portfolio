...
const messages = ref({
  en: {
    ...
    textAboutMe: "A talented front-end developer with more than 1 years of experience in web development. I was born and raised in Tashkent, Uzbekistan, where I was fond of technology and design from an early age. After graduating from a web development course from 'Proweb', I started my professional career in the IT field.",
    mySkills: "My Skills",
  ...
  ru: {
    ...
    textAboutMe: "Талантливый front-end разработчик с опытом работы в веб-разработке более 1 лет. Я родился и вырос в Ташкенте, Узбекистан, где с ранних лет увлекался технологиями и дизайном. После окончания курса веб-разработки от «Proweb» я начал свою профессиональную карьеру в IT-сфере.",
    mySkills: "Мои Навыки",
